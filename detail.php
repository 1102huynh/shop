    ...
    <div class="content_sec">
        ...
        <div class="col2">
            ...
            <div class="listing">
                ...
                <ul>
                 <?php
					$sql='SELECT `id`, `name`, `price`, `img_url` FROM `nn_product` where `category_id`='.$r['category_id'].' order by `id` desc limit 0,20 ';
					$rs=mysqli_query($link,$sql);
					$i=1;
				...
				?>
                	<li <?php if($i%4==0)echo 'class="last"' ?>>
                    	<a href="?id=<?php echo $r['id'] ?>" class="thumb"><img src="images/sanpham/<?php echo $r['img_url']?>" alt="" ></a>
